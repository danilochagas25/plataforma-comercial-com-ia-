    ...
    >
      ...
      >
        <button
          ...
          aria-label="Fechar"
          onClick={onClose}
          className="absolute top-4 right-4 h-8 w-8 rounded-lg flex items-center justify-center text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:bg-[#EEF6F7]"
        >
          <X className="h-4 w-4" />
        </button>
