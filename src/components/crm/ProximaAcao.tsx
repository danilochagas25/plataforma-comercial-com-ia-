...
export function ProximaAcao({ dealId, contactId, deals }: ProximaAcaoProps) {
  ...
  return (
    <section className="space-y-3">
            ...
            return (
              <li
                ...
                className={`rounded-lg border p-3 ${
                  i === 0
                    ? 'border-[rgba(11,110,125,0.40)] bg-[rgba(97,193,208,0.16)]'
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      <span className="rounded-full bg-[#EEF6F7] px-2 py-0.5 text-[10px] font-semibold text-[var(--color-text-secondary)]">
      ...
      <div className="space-y-2 rounded-lg border border-[rgba(97,193,208,0.30)] bg-[#FAFDFD] p-3">
        <input
          value={text}
