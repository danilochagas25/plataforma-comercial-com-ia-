    ...
    >
      {step === 'upload' && (
        <label
          ...
          className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-[rgba(97,193,208,0.55)] bg-[#FAFDFD] p-10 cursor-pointer hover:border-[rgba(11,110,125,0.40)]"
        >
      ...
      {step === 'map' && (
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-[rgba(97,193,208,0.30)] overflow-auto max-h-[340px]">
            <table className="w-full text-xs">
              <thead className="bg-[#F7FBFC] sticky top-0">
                <tr>
                  {headers.map((h, i) => (
                    <th key={i} className="p-2 text-left border-b border-[rgba(97,193,208,0.16)] min-w-[140px]">
                      ...
                      <select
                        ...
                        className="w-full rounded border border-[rgba(97,193,208,0.38)] bg-black/20 px-2 py-1 text-xs text-[var(--color-text-primary)]"
                      >
              ...
              <tbody>
                {previewBody.map((r, i) => (
                  <tr key={i} className="border-b border-[rgba(97,193,208,0.06)]">
                    {headers.map((_, j) => (
      ...
      {step === 'running' && (
        <div className="py-10 flex flex-col items-center gap-4">
          ...
          <div className="w-full max-w-md h-2 rounded-full bg-[#EEF6F7] overflow-hidden">
            <div
