...
export function OriginBlock({ deal }: { deal: DealOriginInput | null | undefined }) {
  ...
  if (!o.tracked) {
    return (
      <section className="space-y-2">
        ...
        <div className="rounded-lg border border-[rgba(97,193,208,0.30)] bg-[#FAFDFD] px-3 py-3 text-sm text-[var(--color-text-secondary)]">
  ...
  return (
    <section className="space-y-2">
      <div className="text-label">Origem</div>
      <div className="space-y-3 rounded-lg border border-[rgba(97,193,208,0.38)] bg-[#FAFDFD] p-3">
        ...
        <div className="space-y-1.5 border-t border-[rgba(97,193,208,0.16)] pt-2">
