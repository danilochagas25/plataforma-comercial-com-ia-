  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="glass-card p-4 space-y-3">
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative min-w-[180px] flex-1">
            ...
            <input
              ...
              className="w-full h-10 pl-10 pr-4 rounded-lg bg-[#F7FBFC] border border-[rgba(97,193,208,0.30)] text-sm placeholder:text-[var(--color-text-secondary)] focus:outline-none focus:border-[var(--accent-primary)]"
            />
          </div>
          <select
            value={tagFilter ?? ''}
            ...
            className="h-10 rounded-lg border border-[rgba(97,193,208,0.30)] bg-[#F7FBFC] px-3 text-sm text-[var(--color-text-primary)]"
          >
        ...
        {selected.size > 0 && (
          <div className="flex items-center gap-2 rounded-lg border border-[rgba(97,193,208,0.55)] bg-[rgba(97,193,208,0.16)] px-4 py-2">
            ...
            <div className="ml-auto flex items-center gap-1 flex-wrap">
              {tags.slice(0, 5).map((t) => (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs bg-[#EEF6F7] hover:bg-[#E4F5F8]"
                >
        ...
        <div className="md:hidden space-y-2">
          {loading ? (
            ...
            contacts.map((c) => (
              <div key={c.id} className="rounded-lg border border-[rgba(97,193,208,0.30)] bg-[#FAFDFD] p-3">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-1.5 text-xs text-[var(--color-text-secondary)]">
                  {c.source && (
                    <span className="inline-flex rounded-full bg-[#EEF6F7] px-2 py-0.5">
                ...
                {c.tags.length > 0 && (
                  <div className="mt-2 flex flex-wrap gap-1">
                    {c.tags.slice(0, 3).map((t) => (
                      <span key={t.id} className="inline-flex items-center gap-1 rounded-full bg-[#EEF6F7] px-2 py-0.5 text-xs">
                        <span className="h-2 w-2 rounded-full" style={{ backgroundColor: t.color }} />
                        {t.name}
                      </span>
                    ))}
                ...
                contacts.map((c) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-[var(--color-text-secondary)]">
                      {c.source ? (
                        <span className="inline-flex rounded-full bg-[#EEF6F7] px-2 py-0.5 text-xs">
                          {CONTACT_SOURCE_LABEL[c.source] ?? c.source}
                        </span>
                      ) : (
                    ...
                    <td className="p-3">
                      <div className="flex flex-wrap gap-1">
                        {c.tags.slice(0, 3).map((t) => (
                          <span
                            key={t.id}
                            className="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs bg-[#EEF6F7]"
                          >
                            <span className="h-2 w-2 rounded-full" style={{ backgroundColor: t.color }} />
                            {t.name}
                          </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <label className="flex items-center gap-1.5 text-xs text-[var(--color-text-secondary)]">
              ...
              <select
                ...
                className="h-8 rounded-lg border border-[rgba(97,193,208,0.30)] bg-[#F7FBFC] px-2 text-xs text-[var(--color-text-primary)]"
              >
